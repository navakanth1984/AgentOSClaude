...
- **NTH Brain Economy Domain:** Grounded in thermodynamic reality via CTP (Cognitive Token Protocol), EVCR (Expected Value to Cost Ratio) scaling, and action pruning.
- **Hierarchical Governance Cascade:** Vetted candidates pass strictly via Governance (Constitution Graph) → Economy (Metabolic engine) → Agency (Action modules).
